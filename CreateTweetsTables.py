...
# Tabla Users
print("------- Creando Users")
# interactions_db.create_insert_data_table_columns_from_data("users", "id", ["usuario"], data)


# Tabla Tweets
print("------- Creando Tweets")
# interactions_db.create_insert_data_table_columns_from_data("tweets", "id", ["texto", "retweets", "favoritos", "fecha"],
#                                                            data)
...
# users_list = interactions_db.export_json_from_table('users')
# tweets_list = interactions_db.export_json_from_table('tweets')
#
# user_tweet_list = []
